      ...
      return [
        {
          ...
          section: document.getElementById('main-collection-product-list').dataset.id,
        }
      ]
    }
    return [
      {
        id: 'main-collection-product-table',
        section: document.getElementById('main-collection-product-table').dataset.id,
      }
    ]
  }
}
